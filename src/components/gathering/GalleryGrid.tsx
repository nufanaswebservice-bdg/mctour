...
const videos = [
  { id: "8PnjNvlukO4", title: "mcTour Highlight" },
...
export default function GalleryGrid() {
  ...
  return (
    <section className="px-4 py-8">
      ...
      {/* Video Gallery */}
      <h2 className="text-lg font-bold font-[family-name:var(--font-heading)] text-dark-text mb-1">Video</h2>
      <p className="text-xs text-muted mb-4">Lihat perjalanan kami di YouTube</p>
          ...
          <div key={video.id} className="flex-shrink-0 w-[200px] snap-start">
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-2 bg-gradient-to-t from-black/70 to-transparent">
                <p className="text-[9px] text-white font-medium truncate">{video.title}</p>
              </div>
            </button>
          </div>
        ))}
